...
<body style="display:flex; flex-direction: column; position: absolute; margin-left: auto; max-width: 970px; border-radius: 3px; background: white; box-shadow: rgba(15, 15, 15, 0.016) 0px 0px 0px 1px, rgba(15, 15, 15, 0.03) 0px 3px 6px, rgba(15, 15, 15, 0.06) 0px 9px 24px; top: 72px; left: 72px; right: 72px; margin-right: auto; height: calc(100% - 144px);">
    ...
    <img src="img/Edution2.png" referrerpolicy="same-origin" style="display: block; object-fit: cover; border-radius: 3px; width: 124.32px; height: 124.32px; transition: opacity 100ms ease-out 0s;"></div></div></div>
        ...
        <form>
            ...
            <input spellcheck="true" placeholder="게시글 제목"  style="border: none; max-width: 100%; width: 100%; white-space: pre-wrap; word-break: break-word; caret-color: rgb(55, 53, 47); padding: 3px 2px;"></div></div>

                <div class="mb-3" style="padding-top: 25px;">
                <label for="exampleFormControlInput1" class="form-label">작성자 이메일</label>
            ...
            <a role="button" type="submit"><div class="jsx-2971364727 button primary button-size-m">게시글 등록하기</div></a>
            <div style="padding: 3px 5px 15px;"></div>
