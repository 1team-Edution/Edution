...
<title class="jsx-1549916940 jsx-1382635649">Edution (에듀션) – 모든 취준생을 위한 하나의 웹 스터디플래너</title>
...
.nav-item.jsx-1177128220{font-weight:544;
font-size:15px;
position:relative}
	...
	<div>
		...
		<div class="jsx-2604928324 inner">
			<div class="jsx-2604928324 desktop-actions">
				<a href="/product" rel="noopener noreferrer" style="display: block; text-decoration: none; user-select: none; cursor: pointer; color: inherit;">
					<div style="display: flex; align-items: center;">
						...
						<!-- 메뉴마다 각 페이지로 이동 -->
		  <div style="flex: 1 1 0%; display: flex; justify-content: center;"></div>
...
<div class="jsx-1177128220 label">Home</div>

<li aria-expanded="false" class="jsx-1177128220 nav-item has-menu">
<div tabindex="0" role="button" class="jsx-3643650412 hoverable">
<a href="CommunityView.do" style="text-decoration: none;"><div class="jsx-1177128220 label">Community</div></a>
...
<li aria-expanded="false" class="jsx-1177128220 nav-item">
<!-- 로그인 페이지로 연결하기 -->
<a tabindex="0" class="jsx-3643650412 hoverable clickable has-action" href="LoginPage.do">
...
<img alt="이미지 넣을 예정!" role="img" src="img/home-page.webp" decoding="async" data-nimg="intrinsic" class="next-image" style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"></span></div></div>
